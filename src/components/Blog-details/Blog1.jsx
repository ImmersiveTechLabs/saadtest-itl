                ...
                <div className="row justify-content-center">
                  <div className="col-lg-10">
                    <div className="cont">
                      ...
                      <h5 className="">Growing Industry</h5>
                      <p>
                      ...
                      <h5 className="">Competitive field</h5>
                      <p>
                      ...
                      <h5 className="">Requires more effort</h5>
                      <p>
                      ...
                      <h4 className="extra-title">Conclusion</h4>
                      <p>
